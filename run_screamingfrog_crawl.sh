...
OUTPUT_DIR="/home/autogpt/sfScripts/screamingfrog_output/${TIMESTAMP}"
...
echo "To generate the PowerPoint presentation, run:"
echo "python3 generate_powerpoint.py ${OUTPUT_DIR}/issues_overview.csv"
